...
mul_layers_dims =  [[3, 256, 256, 1], [256, 256, 1], [256, 256, 1], [256, 256, 1], [256, 256, 1]]                  # this is the structure for MGDL
#set activation for MGDL for each grade
activation = ['sin', 'sin', 'relu', 'relu', 'relu']
#set train epoch for each grade
mul_epochs = [500, 2000, 2000, 2000, 2000]
stop_criterion = [1e-09, 1e-09, 1e-09, 1e-09, 1e-09]
#set max learning rate and min learning rate for each grade
max_learning_rate = [0.1, 0.01, 0.001, 0.001, 0.001]
min_learning_rate = [0.1, 0.001, 0.0001, 0.001, 0.001]
